...
public class WebServiceConfig {
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema employeesSchema) {
        ...
        wsdl11Definition.setTargetNamespace("http://example.com/employee/ws");
    ...
    public XsdSchema employeesSchema() {
        return new SimpleXsdSchema(new org.springframework.core.io.ClassPathResource("xsd/employees.xsd"));
    }
}
